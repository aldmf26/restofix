...
@section('content')
                ...
                <div class="card card-primary card-tabs">
                    <div class="card-header p-0 pt-1">
                        <ul class="nav nav-tabs" id="custom-tabs-two-tab" role="tablist">
                            ...
                            <li class="nav-item">
                                <button data-toggle="modal" id="tbhMenu" data-target="#tbhmenu" class="mt-2 ml-1"><i
    ...
    {{-- form tambah menu sub --}}
    <form action="{{ route('tbhMenu') }}" method="post" accept-charset="utf-8">
        @csrf
        <div class="modal fade" id="tbhmenu" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg-max" role="document">
                <div class="modal-content ">
                    <div class="modal-header btn-costume">
                        <h5 class="modal-title text-light" id="exampleModalLabel">Tambah menu Sub Navbar</h5>
                        <button type="button" class="close text-light" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-4">
                                ...
                                <select class="form-control" name="id_navbar" id="">
                                    <option value="">- id navbar -</option>
                                    @foreach ($navbar as $n)
                                        <option value="{{ $n->id_navbar }}">{{ $n->navbar }} : {{ $n->id_navbar }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-4">
                                ...
                                <input type="text" name="sub_navbar" class="form-control">
                            </div>
                            <div class="col-4">
                                <label for="">Route</label>
                                <input type="text" name="rot" class="form-control">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-6">
                            ...
                            <div class="col-6">
                                ...
                                <?php
                                $urutan = DB::table('tb_sub_navbar')
                                    ->orderBy('urutan', 'desc')
                                    ->first();
                                ?>
                                <input type="hidden" name="id_sub_navbar" value="{{ $urutan->id_sub_navbar+1 }}">
                                <input type="number" name="urutan" readonly value="{{ $urutan->urutan + 1 }}"
                                    class="form-control">
                            </div>
                        </div>
                    </div>
