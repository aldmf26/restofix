...
<table class="table" width="100%">
    ...
    <tbody>
        @foreach ($meja as $m)
            ...
            <tr class="header">
                <td class="bg-ibu" width="8%" style="white-space: nowrap;">
                    <?= $m->nm_meja ?>
                </td>
                <td class="bg-ibu" style="vertical-align: middle;">
                ...
                <td class="bg-ibu"></td>
                <?php foreach ($waitress as $k) : ?>
                <td class="bg-ibu" style="vertical-align: middle;">{{ $k->nama }}</td>
                <?php endforeach ?>
                {{-- disini --}}
                <td colspan="50" class="bg-ibu"><?= number_format($m->total_jam_pesan, 0) ?> Menit</td>
            </tr>
