                            ...
                            <div class="col-lg-8">
                                <div class="row">
                                    ...
                                    <div class="col-lg-5 mb-2">
                                        <label for="">Set</label>
                                        @php
                                            $set = DB::table('tb_menu')->where('nm_menu', 'LIKE', '%Items%')->get();
                                            // dd($set);
                                        @endphp
                                        <select name="id_set" id="setAktif" class="form-control select">
                                            <option value="0">Pilih Set</option>
                                            @foreach ($set as $s)
                                                <option value="{{ $s->id_menu }}" >{{ $s->nm_menu }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="col-lg-2">
                                        <label for="">Qty</label>
                                        <input type="number" readonly id="inQty" class="form-control" name="setQty">
                                    </div>
