...
<div class="card">
    <div class="card-body">
        <h5 style="font-weight: bold; text-align: center;">== {{ $lokasi == '1' ? 'TAKEMORI' : 'SOONDOBU' }} == <a href="{{ route('exportSummary', ['tgl1' => $tgl1, 'tgl2' => $tgl2]) }}" class="btn btn-primary btn-sm float-right">Excel</a></h5>
