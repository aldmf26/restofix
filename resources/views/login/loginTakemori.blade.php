...
<head>
    ...
    <link rel="stylesheet" href="https://upperclassindonesia.com/assets/css/login.css">
</head>
        ...
        <div class="container">
            <div class="card login-card">
                <div class="row no-gutters">
                    <div class="col-md-5">
                        <img src="https://upperclassindonesia.com/uploads/tb_menu/NAMURU MORI.jpg" alt="login"
                            class="login-card-img">
                    </div>
                    <div class="col-md-7">
                        <div class="card-body">
                            <div class="brand-wrapper">
                                <img src="https://upperclassindonesia.com/assets/pages/login/img/Takemori_new.jpg"
                                    alt="logo" class="logo">
                            </div>
